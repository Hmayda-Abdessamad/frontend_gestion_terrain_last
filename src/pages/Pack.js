...
const TABLE_HEAD = [
    ...
    { id: 'tarif', label: 'Tarif', alignRight: false },
    { id: 'nombre_de_match', label: 'Nombre de matche', alignRight: false },
    { id: '' },
];
...
export default function UserPage() {
    ...
    const saveZone =(e)=>{e.preventDefault()
        ...
        formData.append('nbrDeMatches', matches);


        fetch(
            `http://localhost:8085/pack/add/${clubId}`,{
                method:"POST",
                    ...
                    >
                        <Paper elevation={3}>
                            <Box sx={style}>
                                ...
                                <FormHelperText>ce pack appartient à quelle club ?</FormHelperText>
                                <br/>
                                <TextField required label="Tarif" type={"number"}  style={{display:"block" ,marginRight:"1em"}}  value={tarif} onChange={(e)=>setTarif(e.target.value)} />
                                <br/>
                                <TextField required label="nombre de matches " type={"number"}  style={{display:"block" ,marginRight:"1em"}}  value={matches} onChange={(e)=>setMatches(e.target.value)} />
                                <br/>
